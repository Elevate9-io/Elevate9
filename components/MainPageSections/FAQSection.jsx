            ...
            <div className="section6-banner">
                ...
                <div className="section6-accordion-wrapper">
                    ...
                    <li className="section6-accordion-list">
                        ...
                        <label for="first" className="section6-accordion-label">What Makes Elevate9 Different?</label>
                    ...
                    <li className="section6-accordion-list">
                        ...
                        <label for="second" className="section6-accordion-label">Why do I need branding?</label>
                        <div className="section6-accordion-content">
                    ...
                    <li className="section6-accordion-list">
                        ...
                        <label for="third" className="section6-accordion-label">What is search engine optimization (SEO)?</label>
                        <div className="section6-accordion-content">
                    ...
                    <li className="section6-accordion-list">
                        ...
                        <label for="fourth" className="section6-accordion-label">Why do I need SEO marketing for my website?</label>
                        <div className="section6-accordion-content">
                    ...
                    <li className="section6-accordion-list">
                        ...
                        <label for="fifth" className="section6-accordion-label">Why do I need a custom brand identity?</label>
                        <div className="section6-accordion-content">
                    ...
                    <li className="section6-accordion-list">
                        ...
                        <label for="sixth" className="section6-accordion-label">How does web development work?</label>
                        <div className="section6-accordion-content">
                    ...
                    <label for="seventh" className="section6-accordion-label">How often will I receive SEO reports?</label>
                    <div className="section6-accordion-content">
                    ...
                    <li className="section6-accordion-list">
                        ...
                        <label for="eigth" className="section6-accordion-label">How do you ensure that my brand's identity is unique?</label>
                        <div className="section6-accordion-content">
